...
**Important:** These generated model weights are **too large (several GBs)** to be uploaded to GitHub. They are automatically configured to be **ignored** by this repository's `.gitignore`. 
